...
(function (k) {
    "function" === typeof define && define.amd ? define(["src/main/webapp/resources/js/jquery"], function (y) {
        return k(y, window, document)
    }) : "object" === typeof exports ? module.exports = function (y, z) {
        y || (y = window);
        z || (z = "undefined" !== typeof window ? require("src/main/webapp/resources/js/jquery") : require("src/main/webapp/resources/js/jquery")(y));
